<template>
    ...
    <el-form :model="queryParams" ref="queryForm" :inline="true" label-width="120px">
      <el-form-item label="商品名称" prop="objectName">
      ...
      <el-form-item label="商品编码" prop="objectNum">
        <el-input style="width:200px"
    ...
    <el-table v-loading="loading" :data="goodsList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="主进货地" align="center" prop="goodsAddress" />
        <el-table-column label="账面数量" align="center" prop="kcNum" /> 
...
import { listOwnerGoods, getGoods, delGoods, addGoods, updateGoods, exportGoods,goodsRklist } from "@/api/system/ownerGoods";
...
export default {
  ...
  methods: {
    ...
    getList() {
      ...
      // });
     //  this.getTreeselect();
      goodsRklist(this.queryParams).then(response => {
