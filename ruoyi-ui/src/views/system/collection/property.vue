<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="propertyCollectionList" @selection-change="handleSelectionChange">
      <el-table-column type="selection" width="55" align="center" />
      <el-table-column label="收款单号" align="center" prop="collectionCode" />
      <el-table-column label="客户编码" align="center" prop="ownerCode" />
      <el-table-column label="客户名称" align="center" prop="ownerName" />
      ...
      <el-table-column label="收款金额" align="center" prop="collectionMoney" />
      <el-table-column label="收款方式" align="center" prop="collectionPayType" />
...
<script>
import { listPropertyCollection, getPropertyCollection, delPropertyCollection, addPropertyCollection, updatePropertyCollection, exportPropertyCollection } from "@/api/system/propertyCollection";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$confirm('是否确认删除物业收款编号为"' + collectionCodes + '"的数据项?', "警告", {
