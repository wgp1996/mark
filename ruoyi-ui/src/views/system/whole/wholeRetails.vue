<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="是否含税" align="center" prop="isRateName" />
      ...
      <el-tabs v-model="activeName" @tab-click="handleClick">
        <el-tab-pane label="基础信息" name="first">
          <el-form ref="form" :model="form" :rules="rules" label-width="120px">
            <el-form-item label="选择客户" prop="khName">
             ...
             <el-form-item label="销售额" prop="sumMoney">
              <el-input
                v-model="form.sumMoney "
                :disabled="true"
               />
            </el-form-item>
            <el-form-item label="结算" prop="payType">
            ...
            <div class="clearfix">
            <el-form-item label="发票" prop="isRate" style="width:32%;float:left">
              <el-radio-group v-model="form.isRate" @change="changer">
                <el-radio label="0">未税</el-radio>
                <el-radio label="1">含税</el-radio>
              </el-radio-group>
             </el-form-item>
              <el-form-item label="税率(%)" prop="rate" style="width:32%;float:left;text-align:left">
              <el-input
                v-model="form.rate"
                :disabled="shower"
               />
        ...
        <el-tab-pane label="明细信息" name="second">
          ...
          <!-- <el-table-column prop="khCode" label="选择客户" width="200">
            ...
            <el-table-column prop="goodsAddress" label="产地" width="120">
              <template scope="scope">
                <el-input
                 size="small"
...
export default {
  ...
  methods: {
    ...
    handleEdit(index, row) {
      ...
      }else if(this.form.isRate==1){
             if(this.form.rate==""||this.form.rate==null||this.form.rate== undefined ){
                      this.msgError("请先填写税率值!");
                      return;
               }else if(     
                    row.wholePrice != "" &&
                    row.wholePrice != null &&
                    ...
                    row.wholeNum != null &&
                    row.wholeNum != undefined){
                    // alert(parseFloat((1+parseFloat(this.form.rate)/100)))
                    // alert(parseFloat(row.wholePrice))
                    row.wholePrice=  (parseFloat(row.wholePrice)*parseFloat((1+parseFloat(this.form.rate)/100))).toFixed(2)
      ...
      for (let i = 0; i < this.tableData.length; i++) {
        if (this.tableData[i].wholeMoney!= "") {
          sumMoney += parseFloat(this.tableData[i].wholeMoney);
