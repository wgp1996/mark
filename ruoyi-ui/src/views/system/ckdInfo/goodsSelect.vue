<template>
    ...
    :visible.sync="visible" width="900px">
    <el-row :gutter="20">
     <!--部门数据-->
      <!-- <el-col :span="4" :xs="24">
    ...
    <el-table v-loading="loading" :data="goodsList" @selection-change="handleSelectionChange">
      ...
      <!-- <el-table-column label="入库单号" align="center" prop="objectNum" /> -->
      <!-- <el-table-column label="供货商" align="center" prop="objectName" /> -->
      ...
      <el-table-column label="剩余数量" align="center" prop="syNum" />
    </el-table>
    <pagination
      v-show="total>0"
      :total="total"
...
import{selectRkdList}from "@/api/system/lkckInfoChild";
// import {
//    listRandomInspChild, 
  ...
  methods: {
    ...
    getList() {
     ...
     //  this.getTreeselect();
      ...
      //   this.loading = false;
      // });
       selectRkdList(this.queryParams).then(response => {
