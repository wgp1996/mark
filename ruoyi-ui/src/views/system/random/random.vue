      ...
      <el-tabs v-model="activeName" @tab-click="handleClick">
        <el-tab-pane label="基本信息" name="first">
           ...
           <el-form-item label="抑制率标准设定值%" prop="inhibitionNum" >
              <el-input v-model="form.inhibitionNum" placeholder="" @change="changer"/>
            </el-form-item>
        ...
        <el-tab-pane label="明细信息" name="second">
          ...
          >
            ...
            <el-table-column label="检测结论" width="120">
              <template scope="scope">
                <el-input
                  size="small"
  ...
  data() {
    return {
      ...
      rules: {
        ...
        inhibitionNum: [
          { required: true, message: "抑制率标准设定值不能为空", trigger: "blur" },
        ],
        checkAddress: [
  ...
  methods: {
    ...
    handleEdit(index, row) {
      ...
      // if(this.form.isRate==0){
          ...
          // }
          if(row.ai!=""&&row.ai!=null&&row.ai!=undefined&&row.af!=""&&row.af!=null&&row.af!=undefined){
