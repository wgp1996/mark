<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" label-width="100px">
      <el-form-item label="检测人员名称" prop="checkPersonName">
        <el-input
    ...
    >
      ...
      <el-table-column type="selection" width="55" align="center" />
      <el-table-column label="检测人员名称" align="center" prop="checkPersonName" />
      <el-table-column label="检测人员身份证号" align="center" prop="checkPersonId" />
      <el-table-column label="联系电话" align="center" prop="checkPersonTel" />
      <el-table-column label="专业" align="center" prop="checkPersonMajor" />
      <el-table-column label="备注" align="center" prop="checkPersonBz" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="900px">
      ...
      <el-tabs v-model="activeName" @tab-click="handleClick">
        <el-tab-pane label="人员信息" name="first">
           ...
           <el-form-item label="检测人员名称" prop="checkPersonName">
              <el-input v-model="form.checkPersonName" placeholder="请输入检测人员名称" />
            </el-form-item>
            <el-form-item label="身份证号" prop="checkPersonId">
              <el-input v-model="form.checkPersonId" placeholder="请输入身份证号" />
            </el-form-item>
            <el-form-item label="联系电话" prop="checkPersonTel">
              <el-input v-model="form.checkPersonTel" placeholder="请输入联系电话" />
            </el-form-item>
            <el-form-item label="专业" prop="checkPersonMajor">
              <el-input v-model="form.checkPersonMajor"  placeholder="请输入专业" />
            </el-form-item>
             
            <el-form-item label="备注" prop="checkPersonBz">
              <el-input v-model="form.checkPersonBz" placeholder="请输入备注信息" />
            </el-form-item>
        ...
        <!-- <el-tab-pane label="明细信息" name="second">
          <el-form-item label="购置日期"  prop="djTime" >
              <el-date-picker style="width:100%"
                v-model="form.djTime"
                type="date"
                placeholder="购置日期">
            ...
            <el-form-item label="供货单位" prop="remark">
              <el-input v-model="form.remark" placeholder="请输入供货单位" />
            </el-form-item>
            <el-form-item label="供货联系人" prop="remark">
              <el-input v-model="form.remark" placeholder="请输入供货联系人" />
            </el-form-item>
            <el-form-item label="联系电话" prop="remark">
              <el-input v-model="form.remark" placeholder="请输入联系电话" />
            </el-form-item>
            <el-form-item label="售后联系人" prop="remark">
              <el-input v-model="form.remark" placeholder="请输入售后联系人" />
            </el-form-item>
            <el-form-item label="售后电话" prop="remark">
              <el-input v-model="form.remark" placeholder="请输入售后电话" />
            </el-form-item>
        </el-tab-pane> -->
...
export default {
  ...
  created() {
    this.getList();
    // listCheckPerson(this.queryParams).then(response => {
  ...
  methods: {
    ...
    reset() {
      this.form = {
        ...
        isRate:0,
        rows: "",
        checkPersonName: undefined,  checkPersonId: undefined,  checkPersonTel: undefined,  checkPersonMajor: undefined,  checkPersonBz: undefined,
      };
      this.resetForm("form");
      this.tableData = [];
    },
    ...
    handleUpdate(row) {
      ...
      getCheckPerson(id).then((response) => {
        ...
        this.$refs["form"].validate((valid) => {
          if (valid) {
            if (this.form.id != undefined) {
              updateCheckPerson(this.form).then((response) => {
              ...
              addCheckPerson(this.form).then((response) => {
                if (response.code === 200) {
    ...
    handleExport() {
      ...
      this.$confirm("是否确认导出所有租赁单据数据项?", "警告", {
        ...
        .then(function () {
          return exportCheckPerson(queryParams);
        })
        .then((response) => {
